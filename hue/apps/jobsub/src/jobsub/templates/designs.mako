...
${ commonheader("Job designer", "jobsub", user, "60px") | n,unicode }
...
<div id="trashWf" class="modal hide fade">
  <form id="trashWfForm" action="#" method="POST" style="margin:0"> ${ csrf_token_field | n } 
...
<div id="destroyWf" class="modal hide fade">
  <form id="destroyWfForm" action="#" method="POST" style="margin:0"> ${ csrf_token_field | n } 
    <div class="modal-header">
      <a href="#" class="close" data-dismiss="modal">&times;</a>
...
<div id="purgeWf" class="modal hide fade">
  <form id="purgeWfForm" action="#" method="POST" style="margin:0"> ${ csrf_token_field | n } 
    <div class="modal-header">
      <a href="#" class="close" data-dismiss="modal">&times;</a>
...
<div id="restoreWf" class="modal hide fade">
  <form id="restoreWfForm" action="#" method="POST" style="margin:0"> ${ csrf_token_field | n } 
    <div class="modal-header">
      <a href="#" class="close" data-dismiss="modal">&times;</a>
