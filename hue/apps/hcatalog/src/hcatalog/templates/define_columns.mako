...
${ commonheader(_('HCatalog: Create table from file'), app_name, user, '100px') | n,unicode }
        ...
        <div class="span9">
            ...
            <form action="${action}" method="POST" class="form-stacked">
                ...
                <div class="form-actions">
                    ...
                    <input class="btn btn-primary" id="create-table" type="submit" name="submit_create" value="${_('Create Table')}" />
                </div>
            </form>
        </div>
    </div>
