  ...
  $.fn.tagsManager = function (options,tagToManipulate) {
    ...
    var pushTag = function (tag,prefill) {
      ...
      if (alreadyInList) {
        ...
        var separatedName = tagManagerOptions.separateHiddenName;

        var html = '<span class="' + tagClasses() + '" id="' + newTagId + '">';
        html += '<span>' + escaped + '</span>';
        html += '<a href="#" class="tm-tag-remove" id="' + newTagRemoveId + '" TagIdToRemove="' + tagId + '">';
        if (separatedName) {
          html += '<input type="hidden" name="'+separatedName+'" value="'+escaped+'">';
        }
        ...
        refreshHiddenTagList();
        if(!prefill && typeof tagManagerOptions.onAdd == 'function' ) {tagManagerOptions.onAdd();}
