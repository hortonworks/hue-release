...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UDF.description'
        db.alter_column('pig_udf', 'description', self.gf('django.db.models.fields.TextField')(null=True, blank=True))

        # Adding field 'PigScript.arguments'
        db.add_column('pig_pigscript', 'arguments', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Changing field 'UDF.description'
        db.alter_column('pig_udf', 'description', self.gf('django.db.models.fields.TextField')())

        # Deleting field 'PigScript.arguments'
        db.delete_column('pig_pigscript', 'arguments')
