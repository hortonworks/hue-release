...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Job.script_title'
        db.add_column('pig_job', 'script_title', self.gf('django.db.models.fields.CharField')(default='', max_length=200), keep_default=False)

        # Adding field 'Job.user'
        db.add_column('pig_job', 'user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='Jobs', null=True, to=orm['auth.User']), keep_default=False)

        # Changing field 'Job.script'
        db.alter_column('pig_job', 'script_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pig.PigScript'], null=True))
    
    
    def backwards(self, orm):
        
        # Deleting field 'Job.script_title'
        db.delete_column('pig_job', 'script_title')

        # Deleting field 'Job.user'
        db.delete_column('pig_job', 'user_id')

        # Changing field 'Job.script'
        db.alter_column('pig_job', 'script_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pig.PigScript']))
    ...
    models = {
        ...
        'pig.job': {
            ...
            'script': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['pig.PigScript']", 'null': 'True'}),
