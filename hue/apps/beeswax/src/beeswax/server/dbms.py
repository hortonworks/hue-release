...
from beeswax.conf import HIVE_SERVER_HOST, HIVE_SERVER_PORT,\
  BROWSE_PARTITIONED_TABLE_LIMIT, BROWSE_UNPARTITIONED_TABLE_LIMIT, SSL
...
class HiveServer2Dbms(object):
  ...
  def execute_next_statement(self, query_history, hql_query=None):
