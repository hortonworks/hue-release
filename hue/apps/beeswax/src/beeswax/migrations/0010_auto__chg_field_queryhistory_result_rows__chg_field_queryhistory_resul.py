...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'QueryHistory.result_rows'
        db.alter_column('beeswax_queryhistory', 'result_rows', self.gf('django.db.models.fields.BigIntegerField')(null=True))

        # Changing field 'QueryHistory.result_size'
        db.alter_column('beeswax_queryhistory', 'result_size', self.gf('django.db.models.fields.BigIntegerField')(null=True))
    
    
    def backwards(self, orm):
        
        # Changing field 'QueryHistory.result_rows'
        db.alter_column('beeswax_queryhistory', 'result_rows', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'QueryHistory.result_size'
        db.alter_column('beeswax_queryhistory', 'result_size', self.gf('django.db.models.fields.IntegerField')(null=True))
    ...
    models = {
        ...
        'beeswax.queryhistory': {
            ...
            'result_rows': ('django.db.models.fields.BigIntegerField', [], {'null': 'True'}),
            'result_size': ('django.db.models.fields.BigIntegerField', [], {'null': 'True'}),
