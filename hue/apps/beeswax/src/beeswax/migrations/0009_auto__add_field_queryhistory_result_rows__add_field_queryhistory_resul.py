...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'QueryHistory.result_rows'
        db.add_column('beeswax_queryhistory', 'result_rows', self.gf('django.db.models.fields.IntegerField')(null=True), keep_default=False)

        # Adding field 'QueryHistory.result_size'
        db.add_column('beeswax_queryhistory', 'result_size', self.gf('django.db.models.fields.IntegerField')(null=True), keep_default=False)

        # Adding field 'QueryHistory.query_stats'
        db.add_column('beeswax_queryhistory', 'query_stats', self.gf('django.db.models.fields.TextField')(null=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'QueryHistory.result_rows'
        db.delete_column('beeswax_queryhistory', 'result_rows')

        # Deleting field 'QueryHistory.result_size'
        db.delete_column('beeswax_queryhistory', 'result_size')

        # Deleting field 'QueryHistory.query_stats'
        db.delete_column('beeswax_queryhistory', 'query_stats')
